...
url = "https://iss.moex.com/iss/engines/stock/markets/shares/boards/TQBR/securities.json?iss.meta=off&marketdata." \
      "columns=SECID,ISSUECAPITALIZATION&securities.columns=SECID,SHORTNAME,ISSUESIZE"
...
for company in companies_2016.keys():
    for date1 in date_list_2016:
        url2 = f"https://iss.moex.com/iss/history/engines/stock/markets/shares/boards/TQBR/securities/{company}." \
               f"json?from={date1}&history.columns=TRADEDATE,SHORTNAME,OPEN&iss.meta=off"
